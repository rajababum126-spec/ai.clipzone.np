            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between w-full px-4 pt-1">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  <div className="w-20 h-20 rounded-full border-3 border-[#e6c663] p-1.5 flex items-center justify-center shadow-xl bg-[#0a122c] shrink-0 overflow-hidden relative">
                    <img 
                      src={LOGO_DATA_URL} 
                  ...
                  <div className="flex flex-col text-left">
                    <span
                      className="cert-font-playfair font-black text-lg leading-tight tracking-wider text-[#fef08a]"
                      style={{ textShadow: '0 1px 4px rgba(245, 158, 11, 0.4)' }}
                    >
                      AI CLIPZONE
                    </span>
                    <span
                      className="text-[10px] font-black tracking-[0.2em] uppercase text-amber-400/90 leading-none mt-1"
                    >
                      NEPAL 🇳🇵
                    </span>
                  </div>
